...
<p> After working as a teacher for 3 years, my interest in creative things led me to discover web programming and start a new stage in my career. I did a fullstack web development bootcamp where I learnt several technologies (Angular, .Net, Node.js, JavaScript...) although I have a special interest in frontend development. Since then, I have not stopped learning by taking courses.</p>
